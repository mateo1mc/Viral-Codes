...
screen.title('Real Time - @mateo1mc')
...
class Clock:
    ...
    def draw_hand(self):
        ...
        self.hand.up()
        self.hand.goto(0, 0)
        self.hand.seth(90 - math.floor(((self.hour % 12) * 60 * 60 * 1000000 + self.minute * 60 * 1000000 +
                                        self.second * 1000000 + self.microsecond) / 3600000000 * 30))
        self.hand.down()
        ...
        self.hand.up()
        self.hand.goto(0, 0)
        self.hand.seth(90 - math.floor((self.minute * 60 * 1000000 + self.second * 1000000 + self.microsecond) /
                                       60000000 * 6))
        self.hand.down()
        self.hand.color('black')
        self.hand.pensize(4)
